...
function CloseConnection(LocalHost, RemoteHost: string; LocalPort, RemotePort: integer): boolean;
...
begin
  ...
  begin
    ...
    Result := Result + inttostr(PID) + '|' + procname + '|' + Protocolo + '|' +
              LocalHost + ':' + inttostr(LocalPort) + '|' +
              RemoteHost + ':' + inttostr(RemotePort) + '|' + status + '|' + #13#10;
  end;
  ...
  begin
    ...
    Result := Result + inttostr(PID) + '|' + procname + '|' + Protocolo + '|' +
              LocalHost + ':' + inttostr(LocalPort) + '|' +
              RemoteHostUDP + ':' + RemotePortUDP + '|' + status + '|' + #13#10;
  end;
end;
